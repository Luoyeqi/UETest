...
extern ImFont* info_little;
extern ImFont* two;
extern ImFont* three;
extern ImFont* tabsf;
extern ImFont* ee;
extern ImFont* themefont;
extern ImFont* info ;
extern int binda ;
...
namespace ImGui
{
    ...
    IMGUI_API void          SwitchButton(const char* str_id, bool* v);
   ...
   IMGUI_API bool          RadioButton(const char* label, float* v, float v_button);
    ...
    IMGUI_API bool          InputTextSearch(const char* label, char* buf, size_t buf_size, ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void* user_data = NULL);
    ...
    // Text Utilities
    IMGUI_API ImVec2        CountTextSize(ImFont* font, const char* text, float font_size);
    ...
    IMGUI_API ImU32         ColorConvertFloat4ToU32_ARGB(const ImVec4& in);
